...
export default function TimeCard({
  timecard: { id, name, state },
  onArchiveTask,
  onPinTask,
}) {
  return (
    <div className="rounded-2xl min-h-96 bg-header-gray pb-2 max-w-xs ">
      <div className="rounded-2xl h-full bg-background-gray max-w-sm">
        ...
        <div className="flex flex-col flex-grow p-10 w-full">
            <div className="rounded-xl mb-3 mx-10 h-12 bg-item-gray grid place-items-center text-black "><p className="text-sm font-semibold">8:30 - 9:00</p></div>
